...
async function seedSiteData(p: PrismaClient) {
  ...
  await p.announcement.createMany({
    data: [
      {
        text: "📢 2025—2026 оны хичээлийн жилийн нээлтийн ажиллагаа 9-р сарын 1-ний өдөр 09:00 цагт болно",
        order: 0,
      },
      {
        text: "📚 Хичээлийн номын жагсаалт, кабинетын хуваарь батлагдлаа",
        order: 1,
      },
      {
        text: "🛡️ Хүүхэд хамгааллын үзлэг, шалгалт амжилттай явагдлаа",
        order: 2,
      },
      {
        text: "🏆 Манай сургуулийн сурагчид улсын олимпиадаас 27 медаль хүртлээ",
        order: 3,
      },
    ],
  });
  ...
  await p.newsItem.createMany({
    data: [
      {
        tag: "Захиргаа",
        title: "2025—2026 оны хичээлийн жилийн нээлтийн ажиллагаа зарлагдав",
        excerpt: "9-р сарын 1-ний 09:00 цагт төв талбайд болно.",
        date: new Date("2026-08-20"),
        order: 0,
      },
      {
        tag: "Сургалт",
        title: "Хичээлийн номын жагсаалт, кабинетын хуваарь батлагдлаа",
        excerpt:
          "Ангийн ахлах багш нар эцэг эхийн бүлэг чат руу жагсаалтыг хүргэсэн.",
        date: new Date("2026-08-15"),
        order: 1,
      },
      {
        tag: "Хамгаалал",
        title: "Хүүхэд хамгааллын үзлэг, шалгалт эхэллээ",
        excerpt: "Аюулгүй байдлын дотоод үзлэг зохион байгуулав.",
  ...
  const roomData = [
    {
      slug: "entrance",
      label: "Гол хаалга ба фойе",
      subtitle: "Main entrance & foyer",
      description: "Электрон бүртгэлийн хаалга.",
      icon: "DoorOpen",
      order: 0,
      facts: [
        ["Оролт", "3 цэг"],
        ["Ажиллах цаг", "07:30—19:00"],
      ],
    },
    {
      slug: "class",
    ...
    },
    {
      ...
      description: "Сагсан бөмбөгийн заал.",
      icon: "Activity",
      order: 3,
      facts: [
        ["Талбай", "820 м²"],
        ["Хүчин чадал", "300 үзэгч"],
      ],
    },
    {
      slug: "cafeteria",
      ...
      description: "Диетологичийн зөвлөмж.",
    ...
    {
      slug: "yard",
      label: "Сургуулийн хашаа",
      subtitle: "Outdoor yard",
      description: "Тоглоомын талбай.",
      icon: "Trees",
      order: 5,
      facts: [
        ["Талбай", "3,400 м²"],
  ...
  for (const r of roomData) {
    ...
    await p.tourRoomFact.createMany({
      data: facts.map((f, i) => ({
        key: f[0],
        value: f[1],
        roomId: created.id,
  ...
  await p.schoolInfo.createMany({
    data: [
      {
        key: "address",
        value: "Сүхбаатар дүүрэг, 10-р хороо, Нийслэлийн ерөнхий боловсролын 3-р сургууль",
      },
      ...
      {
        key: "quality_national_exam_desc",
        value: "2024-2025 оны улсын шалгалтад 94% нь дээд сургуульд элссэн.",
      },
      {
        key: "quality_teacher_desc",
        value: "Нийт багш нарын 62% нь магистр, докторын зэрэгтэй.",
      },
      {
        key: "protection_policy_1",
        value:
          "Хүүхэд хамгааллын хариуцлагатай ажилтан 08:00—18:00 цагт ажиллана.",
      },
      {
        key: "protection_policy_2",
        value: "Дарамт, хүчирхийллийн мэдээллийн 24/7 нууц утас: 108",
      },
      { key: "protection_policy_3", value: "Сургуулийн орчны камерын хяналт." },
      {
        key: "protection_policy_4",
        value: "Сэтгэл судлаачтай уулзах цагийн захиалга онлайнаар авна.",
      },
    ],
  });
